 ...
 * @author Lenovo
 */
public class guiSWING extends javax.swing.JDialog {

    /**
     * Creates new form guiSWING
     */
    public guiSWING(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Dialog", 0, 44)); // NOI18N
        jLabel1.setText("Enter Passnumber");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                guiSWING dialog = new guiSWING(new javax.swing.JFrame(), true);
